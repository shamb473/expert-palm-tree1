...
export const translations = {
  en: {
    ...
    hero: {
      welcome: 'Welcome to',
      subtitle: 'The heart of agriculture in Keliweli. We provide premium seeds, fertilizers, and expert advice to help you grow more.',
      ...
      service1Desc: 'Access the best seeds, fertilizers, and pesticides tailored for Vidarbha\'s soil and climate.',
      service2Title: 'Market Insights',
      service2Desc: 'Stay updated with real-time mandi rates from Akot, Akola, and major markets to sell at the right price.',
  ...
  mr: {
    ...
    hero: {
      welcome: 'स्वागत आहे',
      subtitle: 'केळीवेळी येथील कृषी केंद्र. आम्ही तुम्हाला अधिक उत्पादन घेण्यास मदत करण्यासाठी उत्तम बियाणे, खते आणि तज्ञांचा सल्ला देतो.',
      ...
      service1Desc: 'विदर्भातील हवामान आणि मातीसाठी योग्य बियाणे, खते आणि कीटकनाशके मिळवा.',
      service2Title: 'बाजार भाव',
      service2Desc: 'अकोला, अकोट आणि प्रमुख बाजारपेठांमधील ताज्या बाजार भावांची माहिती मिळवा.',
      service3Title: 'तज्ञांचे मार्गदर्शन',
      service3Desc: 'आमच्या कृषी मित्र AI आणि स्थानिक तज्ञांकडून पीक सल्ला आणि रोग निदानाची मदत घ्या.',
